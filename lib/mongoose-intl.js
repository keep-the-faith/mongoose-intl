...
module.exports = exports = function mongooseIntl(schema, options) {
    ...
    if (options.defaultLanguage !== '' && (!options.defaultLanguage || pluginOptions.languages.indexOf(options.defaultLanguage) === -1)) {
    ...
    schema.eachPath(function (path, schemaType) {
        ...
        schema.virtual(path)
            .get(function () {
                ...
                if (lang === '' || langSubDoc === null || langSubDoc === void 0) {
                    return langSubDoc;
                }
        ...
        pluginOptions.languages.forEach(function (lang) {
            var langOptions = Object.assign({}, schemaType.options);
    ...
    schema.method({
        ...
        setLanguage: function (lang) {
            if (lang === '' || (lang && this.getLanguages().indexOf(lang) !== -1)) {
